...
ggplot(all_data, aes(x= Age, y = Time, fill = sex, colour = sex))+
  geom_col()
...
The presence of precipitation lowers run time as might be expected
...
#predict(model_f, Division = 'DivisionW0119', PRCP = 1.6)
