...
```{r}
fmodel(model.log, ~ PRCP + sex + Age, nlevels = 3, intervals = "prediction", post_transform = c(Time.y = exp))
```



```{r}
fmodel(model.log, ~ Age + sex, nlevels = 3, intervals = "prediction", post_transform = c(Time.y = exp))
```
