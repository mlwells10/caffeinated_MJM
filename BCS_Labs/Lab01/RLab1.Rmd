...
signal_summary <- function(posX,posY,posZ, orientation, mac){
  subset_data <- subset(relat_access02[relat_access02$posX == posX & relat_access02$posY == posY & relat_access02$posZ == posZ & relat_access02$orientation == orientation & relat_access02$mac == mac],)
