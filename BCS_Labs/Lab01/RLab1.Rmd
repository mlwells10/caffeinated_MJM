...
signal_summary=  function(dat){
  signal = relat_access02$signal[(relat_access02$posX%in%dat[1]) & (relat_access02$posY%in%dat[2])& (relat_access02$posZ %in% dat[3]) & (relat_access02$orientation%in%dat[4])&(relat_access02$mac%in%dat[5])]
  return(c(mean(signal),sd(signal)))
}
