...
dat$Time = as.numeric(seconds(dat$Time))/60.0 #convert Time to second and to double
dat = dat[(!is.na(dat$Time)),] #becuse of convertion to second some data will give NA, and becuase of that, we remove NA again
